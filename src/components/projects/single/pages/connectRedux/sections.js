...
const efficient = {
  caption: `### API efficiecy`,
  content: `This was one of my earliest react/redux apps and I was very proud of how easily it was to get the game logic to work. The immutable and functional approach I took in designing the library made integration into redux a snap. Implementing a naturalistic user experience was an entirely different concern altogether.
...
const vectors = {
  caption: `### Boards Columns and Vector Graphics`,
  content: `
