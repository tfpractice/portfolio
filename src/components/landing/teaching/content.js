...
export const Wesley = {
  ...
  caption: `Without his help, I would not have learned so quickly nor been able to land my first job as a developer.`,
...
export const Chiara = {
  name: 'Chiara D.',
  relationship: 'former student',
  imgUrl: '/images/testimonials/chiara.jpeg',
  position: 'Former Student',
  caption:
    'I gained broader understandings of programming paradigms, how to see them, and how to architect them.',
  content: `While in the Rutgers Coding Bootcamp, Theory was most instrumental in my education of software development for the web. His love for technology inspired me to work hard at my education and I still fall back on that inspiration to this day.
...
export const students = [ Wesley, Chiara ];
