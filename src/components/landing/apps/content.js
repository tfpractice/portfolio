...
export const info = {
  caption: `### Architecture and Experimentation`,
  content: `Working with a separation of concerns has been a critical feature in my development process, making it easy to swap one database or rendering engine for another. This agile development process allows me to focus on more interesting architectural concerns and has lead to a plethora of play apps that take themselves too seriously.

  [FilmRatr](tfp-filmratr.surge.sh) uses multiple AJAX requests to explore the limits of database normalization. [Connect Four](tfp-connect.surge.sh) successfully integrates D3js' DOM manipulation with React's dynamic rendering cycle. And [Venery](tfp-venery.surge.sh) is a guess the word app that became an exercise in natural language processing. I adapt very quickly and treat even trivial problems as opportunities for great solutions`,
};
